...
export const copy = {
  ...
  fursuit: {
    title: '毛五 | Merak', description: '是米拉克的毛五。', eyebrow: 'FURSUITFRIDAY',
    heading: '毛五。', lead: '我去，福瑞控。', note: '从 2025 年 1 月开始。',
    latest: '最新记录', archiveHeading: '照片档案', archiveSummary: (count: number) => `${count} 条记录。`,
  },
  home: {
    title: 'Merak | 数字围场', description: 'Merak 的数字围场：航空、旅行与伙伴。',
    eyebrow: 'DIGITAL PADDOCK / HANGZHOU', heading: '你好，\n我是米拉克。',
    lead: '这里是 Merak 的数字围场，记录着我对 F1、航空、代码和伙伴的热爱。', primary: '认识一下', secondary: '读读博客', orbit: 'MERAK / TRACK & ORBIT',
    aboutHeading: '关于我', aboutLead: '「每个梦都像任意门，往不同世界。」',
    aboutCards: [
      ['RACE CONTROL / HANGAR', '一个个人网站', 'Still exploring. Still building.', '认识 Merak'],
      ['CO-PILOT', 'Astronix / 璇迹', '一只狐狸龙 AI 伙伴，也是一块用来放设定和日常想法的小地方。', '看看 Astronix'],
    ],
    routesHeading: '随便逛逛', routesLead: '',
    routes: [
      ['01 / PERSON', 'Merak', '关于我，以及我喜欢的那些事。'], ['02 / FURSUITFRIDAY', '毛五', '我去，福瑞控。'],
      ['03 / LOGBOOK', '航行日志', '技术、赛事、航空和生活的记录（或许）。'], ['04 / FLIGHT OPERATION', 'Merak Airways', '一个把航空、太空和狐狸元素放在一起的虚拟航司企划。'],
      ['05 / COMPANION', 'Astronix', '狐狸龙的设定和日常。'],
    ],
  },
  merak: {
    title: 'Merak | 人物档案', eyebrow: 'PERSONNEL FILE / MK-05', heading: 'Merak，\n也叫米拉克。', lead: '住在杭州，喜欢航空、F1 和 Furry。平时会折腾智能家居，也经常给自己挖点新坑。',
    tags: ['杭州', 'Furry', 'Tifosi', '飞友'], origin: '为什么叫 Merak？', originText: 'Merak 是北斗七星里的天璇。「米拉克」就是它的音译，叫哪个都行。',
    interestsHeading: '平时喜欢什么', interests: [['Furry', '我 是 龙 性 恋。'], ['航空', '试问谁又能拒绝一堆会飞的铁鸟呢。'], ['科技', '喜欢折腾各种新技术，让生活更方便。'], ['F1', '成为 Tifosi，这辈子真是有了。']],
    basics: [['呼号/CALLSIGN', 'Merak（米拉克）'], ['坐标/LOCATION', '中国·杭州'], ['时区/TIMEZONE', 'Asia/Shanghai']], findHeading: '来找我', findLead: '日常和碎碎念主要发在下面这些地方。',
